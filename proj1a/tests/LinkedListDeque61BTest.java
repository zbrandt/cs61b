...
public class LinkedListDeque61BTest {
    ...
    public void testGet() {
         ...
         assertThat(lld1.get(0) == 0).isTrue();
         assertThat(lld1.get(-2) == null).isTrue();
         assertThat(lld1.get(285564) == null).isTrue();
    }
    ...
    public void testGetRecursive() {
        ...
        assertThat(lld1.getRecursive(0) == 0).isTrue();
        assertThat(lld1.getRecursive(-2) == null).isTrue();
        assertThat(lld1.getRecursive(285564) == null).isTrue();
    }
